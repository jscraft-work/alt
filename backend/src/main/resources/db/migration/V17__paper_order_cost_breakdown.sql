...
--
-- paper_slippage_amount 는 signed (avg_filled_price − requested_price) × filled_quantity 로 적재.
--   BUY 양수 = 의도가보다 비싸게 잡힘 (불리), 음수 = 더 싸게 잡힘 (운 좋음)
--   SELL 양수 = 더 비싸게 팔림 (운 좋음), 음수 = 더 싸게 팔림 (불리)
--
...
ALTER TABLE trade_order
    ...
    ADD COLUMN paper_slippage_amount numeric(19,4),     -- signed (avg_filled_price − requested_price) × filled_quantity
